...
/**
 * baseOn  https://github.com/Bilibili/ijkplayer/blob/master/android/
 * ijkplayer/ijkplayer-example/src/main/java/tv/danmaku/ijk/media/example/widget/media/MeasureHelper.java
 */
public final class MeasureHelper {
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthOriginal = View.getDefaultSize(mVideoWidth, widthMeasureSpec);
        int heightOriginal = View.getDefaultSize(mVideoHeight, heightMeasureSpec);
        ...
        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270) {
            if (widthOriginal < heightOriginal) {
                if (width > height) {
                    width = (int) (width * (float) widthOriginal / height);
                    height = widthOriginal;
                } else {
                    height = (int) (height * (float) width / widthOriginal);
                    width = widthOriginal;
                }
            } else {
                if (width > height) {
